...
<body>
    ...
    <div class="button-container">
        ...
        <a href="{{route('user.userShowMaterials')}}" class="btn btn-outline-darkBlue active">Alphabet</a>
        <a href="{{route('user.userShowNumber')}}" class="btn btn-outline-darkBlue">Number</a>
